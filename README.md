...
- [ ] **Profile Management**
  ...
  - Learning history export (PDF/CSV)
  - Goal setting (# practice sessions, target accuracy)
...
- [ ] **Spaced Repetition**
  - Algorithm to resurface weak concepts
  - Adaptive scheduling of reviews
  - SRS-style question ordering
...
- [ ] **Points & Badges**
  ...
  - Achievement badges (🏆 streak, 🎯 accuracy)
...
- **Slack Bot**: Daily practice reminders
- **Mobile App**: React Native cross-platform
- **Video Content**: Embedding concept videos
